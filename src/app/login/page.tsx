    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0D0D1A] px-5 text-[#F0EBE0]">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="font-serif text-3xl font-semibold">Bienvenido de vuelta</h1>
        </div>

        {checkEmail && (
          <div className="mb-4 rounded-xl border border-[#6BAA8E]/30 bg-[#6BAA8E]/10 px-4 py-3 text-sm text-[#A8D8C0]">
